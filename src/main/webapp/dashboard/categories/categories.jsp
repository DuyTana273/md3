    ...
    <main class="fade-in" id="page-title">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
          <c:forEach var="user" items="${listCategories}" varStatus="loop">
            <tr>
              <td>${loop.count}</td>
              <td>${categories.categories_name}</td>
              <td>${categories.categories_img}</td>
              <td>
                <a href="/categories?action=viewCategories&categories_name=${categories.categories_name}" class="btn btn-primary btn-sm me-1">
